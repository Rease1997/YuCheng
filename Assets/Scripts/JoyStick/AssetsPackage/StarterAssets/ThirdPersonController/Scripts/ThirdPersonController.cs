...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            assetsInputs = this.GetComponent<StarterAssetsInputs>();
            target = transform.Find("TargetPos").gameObject;
            prayTarget = transform.Find("TargetPos/PrayPosition").gameObject;
        ...
        private void GroundedCheck()
        {
            ...
            if (Physics.Raycast(base.transform.position, Vector3.down, out this.hit, 10f))
            {

                if (this.hit.distance < 0.25f)
                {
                    this.Grounded = true;
        ...
        {
            //Debug.Log("JumpAndGravity Grounded："+ Grounded);
            if (Grounded)
            {
